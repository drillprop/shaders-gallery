...
import { Twelfth } from "@/components/shaders/Twelfth/Twelfth";
import { Thirteenth } from "@/components/shaders/Thirteenth/Thirteenth";
import { Fourteenth } from "@/components/shaders/Fourteenth/Fourteenth";
  ...
  return (
    <main className="w-full max-w-screen-2xl ml-auto mr-auto">
      <section className="w-full h-full mt-10 grid grid-cols-[repeat(auto-fill,160px)] gap-2 justify-center">
        ...
        <ShaderCard title="12" url="/shaders/12">
          <Twelfth />
        </ShaderCard>
        <ShaderCard title="13" url="/shaders/13">
          <Thirteenth />
        </ShaderCard>
        <ShaderCard title="14" url="/shaders/14">
          <Fourteenth />
        </ShaderCard>
      </section>
    </main>
